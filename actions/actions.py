...
class ActionRecordHarvest(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        # Example of recording logic or saving data to a database

        # Custom response logic
        dispatcher.utter_message(text=f"Successfully recorded your harvest of {quantity} {item_name} at ${price} per unit.")
